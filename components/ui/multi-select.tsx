            ...
            {selected.map((option) => {
              return (
                <Badge
                  key={option.value}
                  className={cn(
                    'data-[disabled]:bg-slate-300 data-[disabled]:text-black data-[disabled]:hover:border-black',
                    'data-[fixed]:bg-muted-white data-[fixed]:text-muted data-[fixed]:hover:bg-muted-foreground',
